...
<body>
		...
		<form method="post" role="login" action="${pageContext.request.contextPath }/pwSearchOk" onsubmit="return fromCheck()">
			...
			<div>
				<label>아이디</label>			
				<input type="text" name="u_id" required class="form-control" placeholder="Email 입력" id="u_id" value="${u_id}"/>
			</div>
			...
			<div class="p-t-30" style="margin-top: 5px">
    		      <button type="button" class="btn btn-primary btn--green btn-lg" onclick="location.href='login'">취&nbsp;소</button>
   	       		  <button type="submit" class="btn btn-primary btn--green btn-lg" style="margin-left: 5px">비밀번호 찾기</button>
    	    </div>
